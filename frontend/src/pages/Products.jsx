...
const [addProductModalOpen, setAddProductModalOpen] = useState(false);
  ...
  return (
    ...
    <main className='max-w-7xl mx-auto py-6 px-4 lg:px-8'>
        ...
        <Button type='primary' className='my-5' onClick={showAddProductModal}> Add Items</Button>
        <AddProductModal setAddProductModalOpen={setAddProductModalOpen} addProductModalOpen={addProductModalOpen}   />
        {/* CHARTS */}
